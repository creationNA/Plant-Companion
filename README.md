...
State 1 (Critical): If Moisture > DRY_THRESHOLD → Red LED + "NEED WATER!".

State 2 (Warning): If Lux < LIGHT_THRESHOLD → Blue LED + "LOW LIGHT".

State 3 (Normal): All conditions met → Green LED + "PLANT: OK".
